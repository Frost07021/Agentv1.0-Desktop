...
from .model_http import with_reasoning
...
class OpenAICompatibleChatAdapter:
    ...
    async def stream_reply(
        ...
        # qwen3.7 enables thinking by default. Give it a bounded reasoning
        # allowance in addition to (not instead of) the short visible reply.
        payload = with_reasoning(payload, self.settings, default_budget=1024)
