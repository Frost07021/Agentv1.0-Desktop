...
def validate(payload: Any) -> list[str]:
    ...
    for index, segment in enumerate(segments):
        ...
        if not isinstance(content, str) or not content:
            ...
            errors.append(f"{prefix}.content exceeds 150 characters")
    ...
    elif any(not isinstance(item, str) or not item or len(item) > 150 for item in questions):
        errors.append("each suggested question must be a non-empty string up to 150 characters")
